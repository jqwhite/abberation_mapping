...
//file_path = '/Volumes/projects/project-dsaha/insitu_psf_data/grill_lab/andrea/2022-09-05_Beads_256Scope/100nm_Beads_03_1/patches_for_zola'
print("In macro");
print(file_path);
