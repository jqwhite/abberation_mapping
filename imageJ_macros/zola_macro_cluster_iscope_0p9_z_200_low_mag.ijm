...
function processFile(input, file) {
	...
	wid = 64;
	run(" Calibration: PSF modeling", "run_on_gpu gain=1 pixel_size=226 z_step=200 bead_moving=[far -> close to objective] numerical_aperture=0.9 immersion_refractive=1.33 wavelength=0.515 patch_size="+wid+" zernike_coefficient=[Zernike 15 coefs] iteration=100 result_calibration_file="+output);
	run("Close All");
	}
